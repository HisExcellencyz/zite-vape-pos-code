      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card className="bg-card border-border">
          <CardContent className="pt-6">
            ...
            <p className="text-xl font-bold text-foreground mt-1">{fmt(totalPurchases)}</p>
        ...
        <Card className="bg-card border-border">
          <CardContent className="pt-6">
            ...
            <p className="text-xl font-bold text-foreground mt-1">{fmt(totalExpenses)}</p>
        ...
        <Card className="bg-card border-border">
          <CardContent className="pt-6">
            ...
            <p className="text-xl font-bold text-secondary mt-1">{fmt(totalExpenses + totalPurchases)}</p>
          </CardContent>
        </Card>
      </div>
                  ...
                  <tbody>
                    {purchases.length === 0 ? (
                      ...
                      <tr key={p.id} className="border-b border-border hover:bg-muted/30">
                        ...
                        <td className="p-3 text-right font-semibold">{fmt(p.total)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
